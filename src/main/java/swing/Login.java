...
public class Login extends javax.swing.JFrame {
    ...
    private void login_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_login_btnMouseClicked
        ...
        try {
            AccountsEntity user = accountsDao.login(username, password);
            if(user != null) {
                ...
                JOptionPane.showMessageDialog(evt.getComponent().getParent().getParent().getParent(), "Tài khoản hoặc mật khẩu không đúng!");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(evt.getComponent().getParent().getParent().getParent(), "Hệ thống đang có lỗi, vui lòng thử lại sau!");
        }
